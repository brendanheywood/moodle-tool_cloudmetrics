...
$string['onlineusers_time_window_desc'] = 'Metric will include very user who was logged on in this time period.';
$string['activeusers_time_window'] = 'Active user time window';
$string['activeusers_time_window_desc'] = 'Metric will include very user who has been active in this time period.';
$string['newusers_time_window'] = 'Online user time window';
$string['newusers_time_window_desc'] = 'Metric will include very user who first started in this time period.';
