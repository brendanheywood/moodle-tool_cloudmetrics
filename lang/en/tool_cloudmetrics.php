...
$string['onlineusers_time_window_desc'] = 'Metric will include users who was logged on in this time period.';
$string['activeusers_time_window'] = 'Active user time window';
$string['activeusers_time_window_desc'] = 'Metric will include users who has been active in this time period.';
