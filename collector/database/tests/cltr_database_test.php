...
class cltr_database_test extends \tool_cloudmetrics\metric_testcase {
    ...
    public function test_collector() {
        ...
        $rec = array_values($DB->get_records('cltr_database_metrics', null, 'time ASC'));
